...
public class BatchPut extends AbstractGUI
{
    ...
    {
        addToPanel(mainPanel, labelConstraints, 0, 2, new JLabel("COLUMN NAME AND VALUE (eg: NAME:VALUE): ", JLabel.RIGHT));
        addToPanel(mainPanel, editConstraints, 1, 2, NAME_AND_VALUE = new JTextArea());
